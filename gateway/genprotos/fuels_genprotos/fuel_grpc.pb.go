...
const (
	...
	FuelService_DeleteFuelHistoriesByID_FullMethodName  = "/FuelService/DeleteFuelHistoriesByID"
...
type FuelServiceClient interface {
	...
	DeleteFuelHistoriesByID(ctx context.Context, in *DeleteFuelHistoriesByIdRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *fuelServiceClient) DeleteFuelHistoriesByID(ctx context.Context, in *DeleteFuelHistoriesByIdRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, FuelService_DeleteFuelHistoriesByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FuelServiceServer interface {
	...
	DeleteFuelHistoriesByID(context.Context, *DeleteFuelHistoriesByIdRequest) (*Empty, error)
...
func (UnimplementedFuelServiceServer) DeleteFuelHistoriesByID(context.Context, *DeleteFuelHistoriesByIdRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteFuelHistoriesByID not implemented")
}
...
func _FuelService_DeleteFuelHistoriesByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteFuelHistoriesByIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FuelServiceServer).DeleteFuelHistoriesByID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FuelService_DeleteFuelHistoriesByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FuelServiceServer).DeleteFuelHistoriesByID(ctx, req.(*DeleteFuelHistoriesByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FuelService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteFuelHistoriesByID",
			Handler:    _FuelService_DeleteFuelHistoriesByID_Handler,
		},
		{
